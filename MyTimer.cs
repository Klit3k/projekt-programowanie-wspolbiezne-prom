...
namespace PW_Projekt_v5
{
    public class MyTimer
    {
        ...
        private async void fn(object state)
        {
            ...
            if (drogaPrawa.Licznik == 3 && drogaPrawa.Licznik!=3 && (prom.stronaLewa.CurrentCount == 1 && prom.stronaPrawa.CurrentCount == 0))
            {
            ...
            if (drogaLewa.Licznik == 3 && drogaLewa.Licznik != 3 && (prom.stronaLewa.CurrentCount == 0 && prom.stronaPrawa.CurrentCount == 1))
            {
